...
\begin{flalign*}
& \begin{aligned}
\text{trans}(X \to X) &= (a_{\text{rem}} - 1)/\text{rem}_g \\
\text{trans}(X \to Y) &= b_{\text{rem}}/\text{rem}_g \\
\text{trans}(X \to Z) &= o_{\text{groups}}/\text{rem}_g \\
\text{trans}(Y \to X) &= a_{\text{rem}}/\text{rem}_g \\
\text{trans}(Y \to Y) &= (b_{\text{rem}} - 1)/\text{rem}_g \\
\text{trans}(Y \to Z) &= o_{\text{groups}}/\text{rem}_g \\
\text{trans}(Z \to X) &= a_{\text{rem}}/\text{rem}_g \\
\text{trans}(Z \to Y) &= b_{\text{rem}}/\text{rem}_g \\
\text{trans}(Z \to Z) &= (o_{\text{groups}} - 1)/\text{rem}_g
\end{aligned} &
\end{flalign*}
$$
...
& \begin{aligned}
& \textbf{case X + X} \\
& p = (a_{\text{rem}}/\text{groups}) \cdot ((a_{\text{rem}} - 1)/\text{rem}_g) \\
& \\
& \textbf{case Y + Y} \\
& p = (b_{\text{rem}}/\text{groups}) \cdot ((b_{\text{rem}} - 1)/\text{rem}_g) \\
& \\
& \textbf{case Z + Z} \\
& p = (o_{\text{groups}}/\text{groups}) \cdot ((o_{\text{groups}} - 1)/\text{rem}_g) \\
& \\
& \textbf{case X + Y} \\
& p = (a_{\text{rem}}/\text{groups}) \cdot (b_{\text{rem}}/\text{rem}_g) + (b_{\text{rem}}/\text{groups}) \cdot (a_{\text{rem}}/\text{rem}_g) \\
& \\
& \textbf{case X + Z} \\
& p = (a_{\text{rem}}/\text{groups}) \cdot (o_{\text{groups}}/\text{rem}_g) + (o_{\text{groups}}/\text{groups}) \cdot (a_{\text{rem}}/\text{rem}_g) \\
& \\
& \textbf{case Y + Z} \\
& p = (b_{\text{rem}}/\text{groups}) \cdot (o_{\text{groups}}/\text{rem}_g) + (o_{\text{groups}}/\text{groups}) \cdot (b_{\text{rem}}/\text{rem}_g)
\end{aligned} &
\end{flalign*}
$$
...
$$
\begin{flalign*}
& \text{trans}(1 \to 2) = \text{cnp} \cdot (c_{12} / \text{paired}_1) + (1 - \text{cnp}) \cdot (\text{non-paired}_2 / (\text{rem}_g - \text{paired}_1)) &
\end{flalign*}
$$
