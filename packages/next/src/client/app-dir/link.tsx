...
type InternalLinkProps = {
   ...
   *     navigation stage is included. Requires runtime prefetching to be
   *     enabled on the target route (`export const prefetch =
   *     'allow-runtime'`); otherwise it degrades to the `prefetch={true}`
   *     behavior.
