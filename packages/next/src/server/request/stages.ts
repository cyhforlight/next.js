...
import { applyOwnerStack, makeHangingPromise } from '../dynamic-rendering-utils'
...
export function unstable_navigation(): Promise<void> {
  ...
  // TODO(NAR-789): unstable_navigation() is not currently statically prevented from being imported in client components,
